...
INSERT INTO LIVROS(NOME, AUTOR, SEXO, PAGINAS, EDITORA, VALOR, ESTADO,ANO) VALUES
('Cavaleiro Real', 'Ana Cláudia', 'F', 465, 'Atlas', 49.90, 'RJ', 2009),
...
('O poder da mente', 'Clara Mafra', 'F', 120, 'Continental', 56.98, 'SP', 2017);

-- PROJETA TODOS OS DADOS DA TABELA
SELECT * FROM LIVROS;

-- PROJETA NOME E AUTOR INCLUSO NA TABELA
SELECT NOME, AUTOR FROM LIVROS; 

-- PROJETA NOME E UF DOS LIVROS PUBLICADOS POR AUTORAES MASCULINOS
SELECT NOME, ESTADO FROM LIVROS 
WHERE SEXO ='M';

--PROJETA NOME E NÚMERO DE PÁGINAS DOS LIVROS DE AUTORES FEMININOS
SELECT NOME, PAGINAS FROM LIVROS 
WHERE SEXO = 'F';

-- PROJETA OS VALORES DOS LIVROS DE SP
SELECT VALOR FROM LIVROS 
WHERE ESTADO = 'SP';

-- PROJETA DADOS DOS AUTORES MAXCULINOS DE SP OU RJ
SELECT * FROM LIVROS 
WHERE ESTADO = 'SP' 
AND SEXO = 'M' 
OR ESTADO = 'RJ';
...
-- CONTA QUANTOS REGISTROS AGRUPADOS POR SEXO
SELECT SEXO, COUNT(*) FROM LIVROS
GROUP BY SEXO;


/* EXERCICIOS */

-- CRIA BANCO DE DADOS EXERCICIO
...
-- QUANTIDADE SEPARADO POR GRUPOD DE DEPARTAMENTOS
...
-- TELEFONE NÃO OBRIGATÓRIO - UM OU MAIS

-- EM RELACIONAMENTO 1 X 1, A CHAVE ESTRANGEIRA FICA NA TABELA MAIS FRACA

-- EM RELACIONAMENT 1 X N, A CHAVE ESTRANGEIRA FICA NA CARDINALIDADE N


-- INSERINDO DADOS NA TABELA CLIENTE

INSERT INTO CLIENTE VALUES
(NULL, 'JOAO', 'M', 'JOAO@GMAIL.COM', '3125445885'),
(NULL, 'CARLOS', 'M', 'CARLOS@GMAIL.COM', '3125454485'),
(NULL, 'ANA', 'F', 'ANA@GMAIL.COM', '3125452874'),
(NULL, 'CLARA', 'F', NULL, '3125458885'),
(NULL, 'JORGE', 'M', 'JORGE@GMAIL.COM', '5245858885'),
(NULL, 'CELIA', 'F', 'CELIA@GMAIL.COM', '568418885');

+-----------+--------+------+------------------+------------+
| IDCLIENTE | NOME   | SEXO | EMAIL            | CPF        |
+-----------+--------+------+------------------+------------+
|         7 | JOAO   | M    | JOAO@GMAIL.COM   | 3125445885 |
|         8 | CARLOS | M    | CARLOS@GMAIL.COM | 3125454485 |
|         9 | ANA    | F    | ANA@GMAIL.COM    | 3125452874 |
|        10 | CLARA  | F    | NULL             | 3125458885 |
|        11 | JORGE  | M    | JORGE@GMAIL.COM  | 5245858885 |
|        12 | CELIA  | F    | CELIA@GMAIL.COM  | 568418885  |
+-----------+--------+------+------------------+------------+


-- INSERINDO DADOS NA TABELA ENDERECO
INSERT INTO ENDERECO VALUES(NULL, 'RUA ANTONIO SA', 'CENTRO', 'B.HORIZONTE', 'MG', 9);
INSERT INTO ENDERECO VALUES(NULL, 'RUA JURANDI', 'CENTRO', 'SAO PAULO', 'SP', 7);
INSERT INTO ENDERECO VALUES(NULL, 'RUA VINTE E TRES', 'HOLANDES', 'CARAPICUIBA', 'MG', 8);
INSERT INTO ENDERECO VALUES(NULL, 'RUA MARGINAL PINHEIRO', 'COSTA', 'B.HORIZONTE', 'MG', 12);
INSERT INTO ENDERECO VALUES(NULL, 'QR 205 CONJ J', 'GAMA', 'GAMA', 'DF', 11);
INSERT INTO ENDERECO VALUES(NULL, 'RUA ERIOSVALDO', 'CENTRO', 'MACAE', 'MG', 10);

-- INSERINDO DADOS NA TABELA TELEFONE

INSERT INTO TELEFONE VALUES
(NULL, 'RES', '986458544', 7),
(NULL, 'COM', '375698554', 7),
(NULL, 'RES', '896522354', 8),
(NULL, 'CELL', '789563212', 10),
(NULL, 'CELL', '986642295', 11),
(NULL, 'RES', '375641225', 11);


-- TRABALHANDO COM JUNÇÃO DE TABELAS 1 x 1

SELECT NOME, SEXO, BAIRRO, CIDADE
FROM CLIENTE
INNER JOIN ENDERECO -- JUNÇÃO DE TABELA
...
FROM CLIENTE C -- AQUI FOI DADO UM ALIAS PARA CLIENTE
INNER JOIN ENDERECO E -- AQUI FOI DADO UM ALIAS PARA ENDEREÇO
ON C.IDCLIENTE = E.ID_CLIENTE
INNER JOIN TELEFONE T -- AQUI FOI DADO UM ALIAS PARA TELEFONE
...
SELECT NOME, NUMERO, BAIRRO FROM V_RELATORIO;
...
/* CRIANDO PROCEDURES */
DELIMITER $
CREATE PROCEDURE CAD_PRODUTO(P_PRODUTO VARCHAR(50), P_PRECO FLOAT(10,2))
BEGIN
  INSERT INTO PRODUTO VALUES(NULL, P_PRODUTO, P_PRECO);
END
$

DELIMITER ;
CALL CAD_PRODUTO('COXINHA', 5.50);
CALL CAD_PRODUTO('CAZULO', 4.50);
CALL CAD_PRODUTO('BAURÚ', 6.0);
CALL CAD_PRODUTO('EMPADA', 7);

DELIMITER $
CREATE PROCEDURE PRODUTOS_CADASTRADOS()
BEGIN
  SELECT * FROM PRODUTO;
END
$
